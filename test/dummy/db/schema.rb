...
ActiveRecord::Schema.define(:version => 20120522173257) do

  create_table "bcms_content_rotator_slide_versions", :force => true do |t|
  ...
  create_table "bcms_content_rotator_slides", :force => true do |t|
    t.integer  "version"
